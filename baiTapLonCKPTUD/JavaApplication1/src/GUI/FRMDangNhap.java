...
//
//        jLabel6.setIcon(new javax.swing.ImageIcon("D:\\PhatTrienUngDung\\baiTapLonCKPTUD\\baiTapLonCKPTUD\\iCon\\hinhnen-removebg-preview.png")); // NOI18N
//
...
//        );
//        jtxtDangNhap.setText("NV002");
//        jtxtMatKhau.setText("NV002");
//
//        pack();
//        // add sự kiện
...
//    	String mk = jtxtMatKhau.getText().trim();
...
//    			FRMQuanLi frmQL = new FRMQuanLi();
//				frmQL.setVisible(true);
//				this.setVisible(false);
//			}else
//			{
//				JOptionPane.showMessageDialog(null, "Nhân viên đã nghỉ việc rồi "," Thông báo", JOptionPane.WARNING_MESSAGE);
//			}
//    	}
//    }
//    
...
public class FRMDangNhap extends javax.swing.JFrame implements ActionListener{
    ...
    private void checkLogin() {
    	...
    	if(tk.getMaTK()== null) {
    		...
    		NhanVien nv = daoNhanVien.getNVTheoTK(maTk);
    		if(!nv.getTrangThaiLamViec().equalsIgnoreCase("Đã nghỉ việc")){
    			if(daoNhanVien.getNVTheoTK(maTk).getChucVu().matches("Quản lý")) {
        			FRMQuanLi frmQL = new FRMQuanLi(maTk);
    				frmQL.setVisible(true);
    				this.setVisible(false);
    			}
    			///
    			if(daoNhanVien.getNVTheoTK(maTk).getChucVu().matches("Phục vụ")) {
        			FRMQuanLi frmQL = new FRMQuanLi(maTk);
    				frmQL.setVisible(true);
    				this.setVisible(false);
    			}
    			else if(daoNhanVien.getNVTheoTK(maTk).getChucVu().matches("Thu ngân")) {
        			FRMQuanLi frmQL = new FRMQuanLi(maTk);
    				frmQL.setVisible(true);
    				this.setVisible(false);
    			}
