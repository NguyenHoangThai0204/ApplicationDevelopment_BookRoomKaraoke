 ...
 * @author Asus
 */
public class FRMDanhSachHoaDon extends javax.swing.JFrame implements ActionListener,MouseListener {
...
//            },
//            new String [] {
//                "Mã hóa đơn", "Mã khách hàng", "Tên khách hàng", "Mã nhân viên", "Tên nhân viên", "Ngày lập"
//            }
//        ));
        String col1 []={
...
//		jTextFieldThoiGian.setText(tongGioThue+"h : "+tongPhutThue +"'  "+ df.format(tongTienThue));
		jTextFieldThoiGian.setText(tongGioThue+"h : "+tongPhutThue +"  " );
		 jTextFieldTienQuanThoiGian.setText(df.format(tongTienThue));
...
//			lblGiamGia.setText("- "+df.format(hd.getGiamGia()));
	...
	public void loadThongTin(HoaDon hd) {
		jTextFieldPhong.setText(hd.getPhong().getMaPhong());
		jTextFieldGioVao.setText(hd.getGioVao().getHours()+"h");
//		lblPhutVao.setText(hd.getGioVao().getMinutes()+"'");
		jTextFieldGioRa.setText(hd.getGioRa().getHours()+"h");
//		lblPhutRa.setText(hd.getGioRa().getMinutes()+"'");
		jTextFieldTrangThai.setText(hd.getTrangThaiHD());
	}
	////
	public void loadTableCTHD(){
		clearTableCTHD();
		int row = jTable2.getSelectedRow();
		String maHD = moldeHD.getValueAt(row, 0).toString();
