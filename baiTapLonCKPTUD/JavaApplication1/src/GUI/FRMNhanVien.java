...
//        ));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(o.equals(rdoTheoMaNV)) {
			removeDanhSachNV(modelNV);
			loadDanhSachCaNV(daoNhanVien.sortMaNV("ASC"));
		}
		
		if(o.equals(rdoTheoChucVuNV)&& o.equals(jbLocNV)) {
			removeDanhSachNV(modelNV);
			loadDanhSachNV(daoNhanVien.sortCV("ASC"));;
		}
...
//		}
	...
	public void loadDanhSachNV() {
		removeDanhSachNV(modelNV);
		ArrayList<NhanVien> dsNV = daoNhanVien.getDanhSachNV();
	...
	private void sortMaNVTangDan()  {
		removeDanhSachNV(modelNV);
		ArrayList<NhanVien> lstMa = daoNhanVien.sortMaNV("ASC");
		for(NhanVien nv : lstMa) {
			modelNV.addRow(new Object[] {
					nv.getMaNhanVien(), nv.getTenNhanVien(), nv.getSdt(), nv.getDiaChi(), 
					 nv.getCccd(), dfNgaySinh.format(nv.getNgaySinh()), nv.getGioiTinh(), nv.getChucVu()
	...
	private void sortTenNVTangDan()  {
		removeDanhSachNV(modelNV);
		ArrayList<NhanVien> lstTen = daoNhanVien.sortTen("ASC");
	...
	private void sortChucVuTangDan()  {
		removeDanhSachNV(modelNV);
		ArrayList<NhanVien> lstNhanVien = daoNhanVien.sortCV("Nhân viên");
...
//			String trangThai = (String) jTableNV.getValueAt(selectedRow, 10);
