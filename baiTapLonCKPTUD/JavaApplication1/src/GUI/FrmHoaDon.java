...
//		setIconImage(logoApp.getImage());
		...
		btnIn = new javax.swing.JButton("In hóa đơn");
...
//		btnIn.setIcon(iconInHD);
	...
	public void loadHD() {
		...
		for(int i = 0; i<row;i++) {
			int stt = i+1;
			if(model.getValueAt(i, 0).toString().length() >=11)
