...
//		dNow = new Date(nam, thang, ngay);
        ...
        jcboLoaiKH.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Khách hàng thường", "Thành viên thường", "Thành viên VIP" }));
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jcboLoaiKH, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(66, 66, 66)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addComponent(jcboLoaiKH, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(14, 14, 14)
...
//        ));
	...
	public void loadDanhSachKH() {
		...
		for (KhachHang kh : lsKH) {
			...
			modelKH.addRow(new Object[] { kh.getMaKhangHang(), kh.getTenKH(), loaiKH.getTenLoaiKH(),
...
//		LoaiKH loaiKH = new LoaiKH();
		...
		try {
			...
			String gioiTinh = jcboGtinh.getSelectedItem().toString();
			LoaiKH loaiKH = new LoaiKH(daoLoaiKH.getMaLoaiKHTheoTen(jcboLoaiKH.getSelectedItem().toString()));
...
//				Date ngayDangKy=new Date(date1.getYear(), date1.getMonth(), date1.getDate());
	...
	private boolean deleteKH() {
		int row = jTable1.getSelectedRow();
		if(row>=0) {
			int choose=JOptionPane.showConfirmDialog(null, "Bạn muốn xoá khách hàng này ?", "Thông Báo", JOptionPane.YES_NO_OPTION);
			...
			JOptionPane.showMessageDialog(null, "Vui lòng chọn khách hàng để xoá","Thông Báo",JOptionPane.WARNING_MESSAGE);
		}
		return false;
	}

	//sap xep loaiKH tang dan
		public void sortLoaiKH(KhachHang kh) {
		...
		public void sortTenKH(KhachHang kh) {
			clearTable();
			ArrayList<KhachHang> lsKH = daoKhachHang.getDanhSachKH();		
